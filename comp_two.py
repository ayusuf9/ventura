        ...
        for maturity in symbols_dict.keys():
            ...
            if not df_filtered.empty:
                ...
                fig.add_trace(go.Scatter(
                    ...
                    mode='markers',
                    marker=dict(
                        size=df_filtered['sizes'],  # Use the scaled sizes
...
def update_scatter_plot(figure_obj, data, key, relay_data, column):
    # ... (keep the existing code up to the point where size is defined)
    ...
    fig = create_compressed_figure(big_df2, column, symbols_dict, size)
